...
public class GoogleSpreadsheetAuthentication {
     ...
     * @throws AuthenticationException if the service is unable to validate the username and
     *                                 password.
     */
     ...
     *
     * @param consumerKey       consumerKey for the application which is accessing the google
     *                          account
     * @param consumerSecret    consumerSecret for the application which is accessing the
     *                          google account
     * @param accessToken       accessToken received from the google spreadsheet service to
     *                          accessing the google account
     * @param accessTokenSecret accessTokenSecret received from the google spreadsheet service
