    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            ...
            if (worksheetName == null || "".equals(worksheetName.trim())
                ...
                log.error("Please make sure you have given a valid input for the worksheet and spreadsheet names");
                ConnectException connectException = new ConnectException("Please make sure you have given a valid input for the worksheet and spreadsheet names");
            ...
            OMElement searchResult = factory.createOMElement("purgeWorksheetResult", ns);
