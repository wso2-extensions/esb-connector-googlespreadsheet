    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            ...
            if (worksheetName == null || "".equals(worksheetName.trim())
                ...
                log.error("Please make sure you have given a name for the spreadsheet and the worksheet to be deleted");
                ConnectException connectException = new ConnectException("Please make sure you have given a name for the spreadsheet and the worksheet to be deleted");
            ...
            gssWorksheet.deleteWorksheet(worksheetName);
            ...
            OMElement searchResult = factory.createOMElement("deleteWorksheetResult", ns);
