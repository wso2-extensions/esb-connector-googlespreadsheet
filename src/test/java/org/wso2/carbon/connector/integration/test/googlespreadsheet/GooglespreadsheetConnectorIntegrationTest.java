...
public class GooglespreadsheetConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        sheetName = connectorProperties.getProperty("sheetName");
        connectorProperties.setProperty("requestsaddSheetBatchRequest",
                connectorProperties.getProperty("requestsaddSheetBatchRequest").replace("<sheetName>", sheetName));
        connectorProperties.setProperty("ranges", connectorProperties.getProperty("ranges")
                .replace("<sheetName>", sheetName));
        connectorProperties.setProperty("ranges1", connectorProperties.getProperty("ranges1")
                .replace("<sheetName>", sheetName));
        connectorProperties.setProperty("ranges2", connectorProperties.getProperty("ranges2")
                .replace("<sheetName>", sheetName));
        connectorProperties.setProperty("rangeEditCell", connectorProperties.getProperty("rangeEditCell")
                .replace("<sheetName>", sheetName));
        connectorProperties.setProperty("rangeaddRows", connectorProperties.getProperty("rangeaddRows")
                .replace("<sheetName>", sheetName));
        connectorProperties.setProperty("rangeGetCellData", connectorProperties.getProperty("rangeGetCellData")
                .replace("<sheetName>", sheetName));
    }
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testAddSheetBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {getMultipleCellData} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testAddSheetBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {getMultipleCellData} integration test with negative cases.")
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testAddSheetBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {getMultipleCellData} integration test with Optional parameters.")
    public void testGetMultipleCellDataWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                ...
                + connectorProperties.getProperty("ranges") + "&dateTimeRenderOption="
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet {editMultipleCell} " +
    ...
    public void testEditMultipleCellWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_editMultipleCellMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters"},
            description = "googlespreadsheet {editMultipleCell} integration test with negative cases.")
    public void testEditMultipleCellWithNegativeCase() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:editMultipleCell");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "editMultipleCellNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/values:batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
    ...
    public void testEditMultipleCellWithOptionalParameters() throws Exception {
        ...
        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:editMultipleCell");
        connectorProperties.setProperty("data", connectorProperties.getProperty("data").replaceAll("<sheetName>",
                sheetName));
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "editMultipleCellOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/values:batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {createSpreadsheet} integration test " +
    ...
    public void testCreateSpreadsheetWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:createSpreadsheet");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "createSpreadsheetNegative.json");
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet {getSheetMetaData} " +
            "integration test with mandatory parameters.")
    public void testGetSheetMetaDataWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "getSheetMetaDataMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {getSheetMetaData} integration test with " +
            "negative cases.")
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters"},
            description = "googlespreadsheet {addSheetBatchRequest} integration test with mandatory parameters.")
    public void testAddSheetBatchRequestWithMandatoryParameters() throws Exception {
        ...
        connectorProperties.setProperty("requestsUpdateConditionalFormatRuleBatchRequest",
                connectorProperties.getProperty("requestsUpdateConditionalFormatRuleBatchRequest")
                        .replaceAll("<sheetId>", connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsDeleteConditionalFormatRuleBatchRequest",
                connectorProperties.getProperty("requestsDeleteConditionalFormatRuleBatchRequest")
                        .replaceAll("<sheetId>", connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsDeleteConditionalFormatRuleOptional",
                connectorProperties.getProperty("requestsDeleteConditionalFormatRuleOptional").replaceAll("<sheetId>",
                        connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsaddConditionalFormatRuleOptional",
                connectorProperties.getProperty("requestsaddConditionalFormatRuleOptional").replace("<sheetId>",
                        connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsAutoResizeDimensionsBatchRequest",
                connectorProperties.getProperty("requestsAutoResizeDimensionsBatchRequest").replace("<sheetId>",
                        connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsAppendDimension", connectorProperties.getProperty(
                "requestsAppendDimension").replace("<sheetId>", connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("requestsdeleteSheetBatchRequest", connectorProperties.getProperty(
                "requestsdeleteSheetBatchRequest").replace("<sheetId>", connectorProperties.getProperty("sheetId")));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {addSheetBatchRequest} integration test " +
            "with negative cases.")
    public void testAddSheetBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:addSheetBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addSheetBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters"},
            description = "googlespreadsheet {addSheetBatchRequest} integration test with Optional parameters.")
    public void testAddSheetBatchRequestWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:addSheetBatchRequest");
        connectorProperties.setProperty("requestsaddSheetBatchRequest1", connectorProperties.getProperty(
                "requestsaddSheetBatchRequest1").replace("<sheetName>",
                connectorProperties.getProperty("sheetNameOptional2")));
        connectorProperties.setProperty("apiAddSheetOptional", connectorProperties.getProperty("apiAddSheetOptional")
                .replace("<sheetName>", connectorProperties.getProperty("sheetNameOptional")));
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addSheetBatchRequestOptional.json");
        ...
        connectorProperties.setProperty("requestsMoveDimensionBatchRequest", connectorProperties.getProperty(
                ...
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsMergeCellsBatchRequest", connectorProperties.getProperty(
                "requestsMergeCellsBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsRepeatCellsBatchRequest", connectorProperties.getProperty(
                "requestsRepeatCellsBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsSetDataValidationBatchRequest", connectorProperties.getProperty(
                "requestsSetDataValidationBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsSortRangeBatchRequest", connectorProperties.getProperty(
                "requestsSortRangeBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsUpdateBordersBatchRequestMandatory", connectorProperties.getProperty(
                "requestsUpdateBordersBatchRequestMandatory").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsUpdateCellsBatchRequest", connectorProperties.getProperty(
                "requestsUpdateCellsBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsUpdateDimensionPropertiesBatchRequest", connectorProperties.getProperty(
                "requestsUpdateDimensionPropertiesBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsInsertDimensionBatchRequest", connectorProperties.getProperty(
                "requestsInsertDimensionBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestDeleteDimensionBatchRequest", connectorProperties.getProperty(
                "requestDeleteDimensionBatchRequest").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        connectorProperties.setProperty("requestsdeleteSheetBatchRequest1", connectorProperties.getProperty(
                "requestsdeleteSheetBatchRequest1").replace("<sheetIdOptional>",
                connectorProperties.getProperty("sheetIdOptional")));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{updateSheetPropertiesBatchRequest} integration test with mandatory parameters.")
    public void testUpdateSheetPropertiesBatchRequestWithMandatoryParameters() throws Exception {
        ...
        connectorProperties.setProperty("requestsupdateSheetPropertiesBatchRequest", connectorProperties.getProperty(
                "requestsupdateSheetPropertiesBatchRequest").replace("<sheetName>", connectorProperties.getProperty(
                "sheetName")).replace("<sheetId>", connectorProperties.getProperty("sheetId")));
        connectorProperties.setProperty("apiUpdateSheetProperties", connectorProperties.getProperty(
                "apiUpdateSheetProperties").replace("<sheetName>", connectorProperties.getProperty("sheetName"))
                .replace("<sheetId>", connectorProperties.getProperty("sheetId")));
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {updateSheetPropertiesBatchRequest} integration" +
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters",
            "testUpdateSheetPropertiesBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{updateSheetPropertiesBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{addConditionalFormat RuleBatchRequest} integration test with mandatory parameters.")
    public void testAddConditionalFormatRuleBatchRequestWithMandatoryParameters() throws Exception {
        ...
        connectorProperties.setProperty("requestsaddConditionalFormatRuleBatchRequest", connectorProperties.getProperty(
                "requestsaddConditionalFormatRuleBatchRequest").replace("<sheetId>",
                connectorProperties.getProperty("sheetId")));
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {addConditionalFormatRuleBatchRequest} integration " +
            "test with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{addConditionalFormatRuleBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{appendDimensionBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {appendDimensionBatchRequest} integration test" +
            " with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}
            , description = "googlespreadsheet {appendDimensionBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{autoResizeDimensionsBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {autoResizeDimensionsBatchRequest} integration " +
            "test with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{autoResizeDimensionsBatchRequest} integration test with Optional parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"},
            description = "googlespreadsheet {copyPasteBatchRequest} integration test with mandatory parameters.")
    public void testCopyPasteBatchRequestWithMandatoryParameters() throws Exception {
        ...
        connectorProperties.setProperty("requestsCopyPasteBatchRequest", connectorProperties.getProperty(
                "requestsCopyPasteBatchRequest").replace("<sheetId>", connectorProperties.getProperty("sheetId"))
                .replace("<sheetIdOptional>", connectorProperties.getProperty("sheetIdOptional")));
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_copyPasteBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {copyPasteBatchRequest} integration test " +
            "with negative cases.")
    public void testCopyPasteBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:copyPasteBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "copyPasteBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters", "testAddSheetBatchRequestWithOptionalParameters",
            "testCopyPasteBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {copyPasteBatchRequest} integration test with Optional parameters.")
    public void testCopyPasteBatchRequestWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:copyPasteBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "copyPasteBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{cutPasteBatchRequest} integration test with mandatory parameters.")
    public void testCutPasteBatchRequestWithMandatoryParameters() throws Exception {
        ...
        connectorProperties.setProperty("requestsCutPasteBatchRequest", connectorProperties.getProperty(
                "requestsCutPasteBatchRequest").replace("<sheetId>", connectorProperties.getProperty("sheetId"))
                .replace("<sheetIdOptional>", connectorProperties.getProperty("sheetIdOptional")));
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_cutPasteBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {cutPasteBatchRequest} integration test with " +
            "negative cases.")
    public void testCutPasteBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:cutPasteBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "cutPasteBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters", "testCutPasteBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {cutPasteBatchRequest} integration test with Optional parameters.")
    public void testCutPasteBatchRequestWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:cutPasteBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "cutPasteBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{deleteDimensionBatchRequest} integration test with mandatory parameters.")
    public void testDeleteDimensionBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_deleteDimensionBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {deleteDimensionBatchRequest} integration test " +
            "with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {deleteDimensionBatchRequest} integration test with Optional parameters.")
    public void testDeleteDimensionBatchRequestWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:deleteDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteDimensionBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet {getCellData}" +
            " integration test with mandatory parameters.")
    ...
    public void testGetCellDataWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:getCellData");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "getCellDataNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"},
            description = "googlespreadsheet {getCellData} integration test with Optional parameters.")
    public void testGetCellDataWithOptionalParameters() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("range"), apiRestResponse.getBody().get("range"));
    }
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet" +
            " {insertDimensionBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {insertDimensionBatchRequest} integration " +
            "test with negative cases.")
    public void testInsertDimensionBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:insertDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "insertDimensionBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}
            , description = "googlespreadsheet {insertDimensionBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"},
            description = "googlespreadsheet {mergeCellsBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {mergeCellsBatchRequest} integration test " +
            "with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{mergeCellsBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{moveDimensionBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {moveDimensionBatchRequest} integration test " +
            "with negative cases.")
    public void testMoveDimensionBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:moveDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "moveDimensionBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{moveDimensionBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{repeatCellsBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {repeatCellsBatchRequest} integration test " +
            "with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{repeatCellsBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{setDataValidationBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {setDataValidationBatchRequest} integration test " +
            "with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{setDataValidationBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{sortRangeBatchRequest} integration test with mandatory parameters.")
    public void testSortRangeBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_sortRangeBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {sortRangeBatchRequest} integration test" +
            " with negative cases.")
    public void testSortRangeBatchRequestWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:sortRangeBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "sortRangeBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{sortRangeBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateBordersBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {updateBordersBatchRequest} integration test" +
            " with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateBordersBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateCellsBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {updateCellsBatchRequest} integration test " +
            "with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateCellsBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters",
            "testAddConditionalFormatRuleBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{updateConditionalFormatRuleBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {updateConditionalFormatRuleBatchRequest} " +
            "integration test with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters",
            "testAddConditionalFormatRuleBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{updateConditionalFormatRuleBatchRequest} integration test with Optional parameters.")
    public void testUpdateConditionalFormatRuleBatchRequestWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:updateConditionalFormatRuleBatchRequest");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "updateConditionalFormatRuleBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateDimensionPropertiesBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {updateDimensionPropertiesBatchRequest} " +
            "integration test with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{updateDimensionPropertiesBatchRequest} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            ...
            description = "googlespreadsheet {copyTo} integration test with mandatory parameters.")
    ...
    public void testCopyToWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:copyTo");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "copyToNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/sheets/"
                + connectorProperties.getProperty("sheetId")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters", "testCreateSpreadsheetWithOptionalParameters"},
            description = "googlespreadsheet {copyTo} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters",
            "testUpdateConditionalFormatRuleBatchRequestWithMandatoryParameters",
            "testUpdateConditionalFormatRuleBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{deleteConditionalFormatRuleBatchRequest} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {deleteConditionalFormatRuleBatchRequest} " +
            "integration test with negative cases.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters",
            "testAddConditionalFormatRuleBatchRequestWithOptionalParameters"}, description = "googlespreadsheet " +
            "{deleteConditionalFormatRuleBatchRequest} integration test with Optional parameters.")
     ...
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlespreadsheet {deleteSheetBatchRequest} integration test " +
            "with mandatory parameters.")
    public void testDeleteSheetBatchRequestWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                ...
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                "api_deleteSheetBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    }
     ...
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlespreadsheet {deleteSheetBatchRequest} integration test with " +
            "negative cases.")
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters"},
            description = "googlespreadsheet {editCell} integration test with mandatory parameters.")
    public void testEditCellWithMandatoryParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:editCell");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "editCellMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/values/"
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters"},
            description = "googlespreadsheet {editCell} integration test with Optional parameters.")
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{addRowsColumnsData} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "googlespreadsheet {addRowsColumnsData} integration test" +
            " with negative cases.")
    public void testAddRowsColumnsDataWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:addRowsColumnsData");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addRowsColumnsDataNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/values/"
                + connectorProperties.getProperty("rangeaddRows") + ":append?valueInputOption="
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateSpreadsheetWithMandatoryParameters",
            "testAddSheetBatchRequestWithMandatoryParameters"}, description = "googlespreadsheet " +
            "{addRowsColumnsData} integration test with Optional parameters.")
    public void testAddRowsColumnsDataWithOptionalParameters() throws Exception {

        Thread.sleep(sleepingTime);
        esbRequestHeadersMap.put("Action", "urn:addRowsColumnsData");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_addRowsColumnsDataOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/"
                + connectorProperties.getProperty("spreadsheetId") + "/values/"
                + connectorProperties.getProperty("rangeaddRows") + ":append?valueInputOption="
                + connectorProperties.getProperty("valueInputOptionaddRows") + "&fields="
